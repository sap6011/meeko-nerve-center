...
def run():
    ...
    if blocked_c > 0:
        lines.append(
            ...
            f"ANTHROPIC_API_KEY powers the brain. "
    ...
    entry["nervous_system"]={"equilibrium":_h.get("equilibrium",0),"trend":_h.get("trend","unknown"),"brain_confidence":_c.get("decision_confidence",0)}
