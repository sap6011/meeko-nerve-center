...
def L6():
    ...
    eng("HOMEOSTASIS",              timeout=30)   # v60: active equilibrium -- health zones, fire ledger, race prevention
    eng("EXECUTIVE_FUNCTION",       timeout=60)   # v59: motor cortex -- executes brain's top action + CRITICAL triage
