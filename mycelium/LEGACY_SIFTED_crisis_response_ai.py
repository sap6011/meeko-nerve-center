...
if __name__ == "__main__":
    ...
    (DATA / "legacy_sifted_crisis_response_ai_state.json").write_text(json.dumps({"last_run": __import__("datetime").datetime.now().isoformat(), "status": "ok"}, indent=2), encoding="utf-8")
