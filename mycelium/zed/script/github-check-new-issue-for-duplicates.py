...
Environment variables:
    ...
    os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")  - Anthropic API key for Claude
...
if __name__ == "__main__":
    ...
    if not anthropic_key:
        log("Error: os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")") not set")
        sys.exit(1)
