...
class ZedAgent(BaseInstalledAgent):
    ...
    def _get_api_env(self) -> dict[str, str]:
        ...
        provider_env_map = {
            "anthropic": "os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")")")")")")")")")")",
