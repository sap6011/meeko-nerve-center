...
SECRETS_NEEDED = {
    "ANTHROPIC_API_KEY":    {"pts": 15, "category": "AI Brain", "how": "console.anthropic.com -> API Keys"},
...
def score_and_report():
    ...
    if api_ok:
        ...
        fixes.append("Go to anthropic.com/console -> API Keys -> Create new key -> Add as ANTHROPIC_API_KEY")
