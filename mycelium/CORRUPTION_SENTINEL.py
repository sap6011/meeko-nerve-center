...
Known corruption patterns:
  ...
  4. Bare ANTHROPIC_API_KEY self-assignment
...
CORRUPTION_PATTERNS = [
    ...
    # Bare ANTHROPIC_API_KEY as variable (not in string, not as getenv arg)
    (r'(?<!["\'])(?<!getenv\(["\'])ANTHROPIC_API_KEY\s*=\s*ANTHROPIC_API_KEY', "bare ANTHROPIC_API_KEY self-assignment"),
