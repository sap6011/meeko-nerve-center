...
CORRUPTION_PATTERNS = [
    ...
    # Bare os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")") self-assignment
    (r'os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")\s*=\s*os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")', "bare os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")") self-assignment"),
