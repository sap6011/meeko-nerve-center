...
Known corruption patterns:
  ...
  4. Bare os.getenv("os.getenv("ANTHROPIC_API_KEY")") self-assignment
...
CORRUPTION_PATTERNS = [
    ...
    # Bare os.getenv("ANTHROPIC_API_KEY") self-assignment
    (r'os.getenv("ANTHROPIC_API_KEY")\s*=\s*os.getenv("ANTHROPIC_API_KEY")', "bare os.getenv("ANTHROPIC_API_KEY") self-assignment"),
