...
def call_claude(stats, a_report, b_report):
    if not os.getenv("ANTHROPIC_API_KEY"):
        ...
        return {
            ...
            "synthesis": f"{stats['engines_total']} engines running, {stats['cycles']} autonomous cycles done. No API key - running on pure logic. First priority: add os.getenv("ANTHROPIC_API_KEY"),
