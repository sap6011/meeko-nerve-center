...
DEFAULT_SCHEDULE = {
    ...
    "HOMEOSTASIS":      10,   # Every 10 min -- active equilibrium (health zones, fire ledger, race prevention)
...
def run_engine(engine_name):
    ...
    try:
        if engine_name == "TURBO_TRADER":
            ...
            result = run()
        elif engine_name == "HOMEOSTASIS":
            from mycelium.HOMEOSTASIS import run
            result = run()
