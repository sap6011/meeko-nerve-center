...
ANTHROPIC_KEY = os.environ.get("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")", "").strip()
...
def _ask_anthropic(messages, max_tokens=2000, system=None):
    ...
    if not ANTHROPIC_KEY:
        raise RuntimeError("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")") not set")
