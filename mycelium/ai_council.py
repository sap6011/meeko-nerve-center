...
Required:
  os.environ.get("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")", "")
  GH_PAT / GITHUB_TOKEN
...
# ── Config ─────────────────────────────────────────────────────────────────
os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")") = os.environ.get("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")", "")
...
def call_analyst(context_str):
    if not os.environ.get("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")", ""):
        print("❌ os.environ.get("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")", "")
        sys.exit(1)
    print("  🔬 ANALYST reading system...")
    r = requests.post(
        "https://api.anthropic.com/v1/messages",
        headers={"x-api-key": os.environ.get("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")", ""),
