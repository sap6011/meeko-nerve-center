...
Required:
  os.environ.get("os.getenv("os.getenv("ANTHROPIC_API_KEY")")", "").strip(),
  GH_PAT / GITHUB_TOKEN
...
def call_analyst(context_str):
    ...
    r = requests.post(
        ...
        headers={"x-api-key": os.environ.get("os.environ.get("os.getenv("os.getenv("ANTHROPIC_API_KEY")")", "").strip()", "").strip(),
