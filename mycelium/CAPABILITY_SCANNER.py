...
def scan():
    ...
    caps = {
        "anthropic_api": {
            "name": "Claude API",
            "status": "active" if os.environ.get("os.getenv("ANTHROPIC_API_KEY")"else "blocked",
    ...
    priority = (
        "os.getenv("ANTHROPIC_API_KEY")" if not os.environ.get("os.getenv("ANTHROPIC_API_KEY")"else
