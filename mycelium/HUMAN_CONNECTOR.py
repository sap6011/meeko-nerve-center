...
API=os.environ.get("os.environ.get("os.getenv("ANTHROPIC_API_KEY")", "").strip()", "").strip()
...
2. Add Secrets (Settings -> Secrets -> Actions):
   - os.environ.get("os.getenv("ANTHROPIC_API_KEY")", "").strip() (get from console.anthropic.com)
