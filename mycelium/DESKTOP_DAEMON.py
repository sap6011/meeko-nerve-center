...
API_KEY        = os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")
...
def run_loop():
    ...
    if not API_KEY:
        log("WARNING: os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")") not set")
        log("  Windows: $env:os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")='sk-ant-...'")
...
<Task version="1.4" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Actions>
    ...
    if err and "error" in err.lower():
        ...
        print(f"   Add os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")") to env for full Claude brain")
