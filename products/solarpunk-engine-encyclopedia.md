...
**Purpose:** CHANNEL_ROUTER.py -- Multi-Channel Fallback Router
...
**Functions:** `load_json_safe`, `detect_channel_status`, `is_channel_usable`, `route_task`, `process_queue`, `build_state_report`, `_status_badge`, `_capability_pills`, `generate_html_dashboard`, `run`
...
### GENERATED_ASKS_QUEUE_POPULATOR

**Purpose:** GENERATED_ASKS_QUEUE_POPULATOR.py -- Auto-generated by FRACTAL_GENESIS_ENGINE
...
### GENERATED_CRYPTO_WATCHER_CONSUMER

**Purpose:** GENERATED_CRYPTO_WATCHER_CONSUMER.py -- Auto-generated by FRACTAL_GENESIS_ENGINE
...
### GENERATED_DATA_FLOW_OBSERVATORY_CONSUMER

**Purpose:** GENERATED_DATA_FLOW_OBSERVATORY_CONSUMER.py -- Auto-generated by FRACTAL_GENESIS_ENGINE
...
**Reads:** live_wire_report.json, observatory_report.json

**Writes:** data/data_flow_observatory_insights.json
...
### GENERATED_FIRST_DOLLAR_ENGINE_CONSUMER

**Purpose:** GENERATED_FIRST_DOLLAR_ENGINE_CONSUMER.py -- Auto-generated by FRACTAL_GENESIS_ENGINE
...
**Reads:** first_dollar_plan.json, first_dollar_engine_state.json

**Writes:** data/first_dollar_engine_insights.json
...
### GENERATED_MUTATION_VAULT_CONSUMER

**Purpose:** GENERATED_MUTATION_VAULT_CONSUMER.py -- Auto-generated by FRACTAL_GENESIS_ENGINE
...
### GENERATED_KOFI_PAYMENT_TRACKER_CONSUMER

**Purpose:** GENERATED_KOFI_PAYMENT_TRACKER_CONSUMER.py -- Auto-generated by FRACTAL_GENESIS_ENGINE
...
### GENERATED_QUICK_REVENUE_CONSUMER

**Purpose:** GENERATED_QUICK_REVENUE_CONSUMER.py -- Auto-generated by FRACTAL_GENESIS_ENGINE
...
**Reads:** revenue_inbox.json, quick_revenue.json

**Writes:** data/quick_revenue_insights.json
...
**Purpose:** MACHINE_REVENUE — AI-to-AI Revenue Engine
...
**Functions:** `scan_bounty_opportunities`, `generate_app_manifest`, `generate_acp_catalog`, `generate_affiliate_links`, `load_json`, `run`
...
**Purpose:** INTERNET_BRIDGE.py — Connects SolarPunk to the live internet
...
**Functions:** `_ts`, `_load`, `_save`, `_fetch_json`, `_fetch_text`, `_sh`, `gather_github_signals`, `gather_trending_signals`, `gather_market_signals`, `gather_humanitarian_signals`, `publish_status_page`, `publish_signals_page`, `sync_discussions`, `run`
...
**Purpose:** EMAIL_INTELLIGENCE — SolarPunk Smart Outreach Brain
...
**Functions:** `verify_mx`, `verify_email`, `scan_bounces_from_state`, `parse_bounce_address`, `generate_personalized_email`, `build_verified_contacts`, `build_outreach_queue`, `compute_outreach_economics`, `load_json`, `run`
