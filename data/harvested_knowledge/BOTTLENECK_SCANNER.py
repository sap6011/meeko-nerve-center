...
def identify_bottlenecks(secrets, engines, gumroad, revenue):
    ...
    if anthropic and not anthropic["present"]:
        bottlenecks.append({
            ...
            "fix": "console.anthropic.com -> API Keys -> Create -> GitHub Secret: os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")",
    ...
    if broken:
        bottlenecks.append({
            ...
            "fix": "Fix os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")") to enable AI auto-patching via AUTO_HEALER",
