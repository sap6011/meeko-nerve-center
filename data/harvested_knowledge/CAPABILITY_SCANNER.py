...
def scan():
    ...
    caps = {
        "anthropic_api": {
            ...
            "fix": "anthropic.com/console → API Keys → add os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")") to GitHub Secrets",
        ...
        "huggingface": {
            ...
            "fix": "Add os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")") — HF fallback not needed if Claude works",
