...
1. Fork this repo
2. Add Secrets: `os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")")`, `GMAIL_ADDRESS`, `GMAIL_APP_PASSWORD`
