...
Health score (100 pts):
  20 — os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")") valid
...
def score_and_report():
    ...
    if api_ok:
        ...
        fixes.append("Go to anthropic.com/console → API Keys → Create new key → Add as os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")") in GitHub Secrets")
