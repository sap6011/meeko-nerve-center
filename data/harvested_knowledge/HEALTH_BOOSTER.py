...
Health score (100 pts):
  20 — os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")") valid
...
SECRETS_NEEDED = {
    "os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")")":    {"pts": 20, "category": "AI",       "how": "anthropic.com/console → API Keys"},
...
def check_api_key():
    key = os.environ.get("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")")", "")
    if not key:
        return False, "os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")") not set"
    try:
...
def score_and_report():
    ...
    if api_ok:
        ...
        fixes.append("Go to anthropic.com/console → API Keys → Create new key → Add as os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")") in GitHub Secrets")
