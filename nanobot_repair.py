...
def check_secret_placeholders():
    ...
    secrets = ["os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")")")")", "X_API_KEY", "GMAIL_APP_PASSWORD"]
