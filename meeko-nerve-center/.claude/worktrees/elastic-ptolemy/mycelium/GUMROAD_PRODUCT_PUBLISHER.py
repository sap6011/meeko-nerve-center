...
TOKEN = (
    (os.environ.get("GUMROAD_ACCESS_TOKEN") or "").strip() or
    (os.environ.get("GUMROAD_SECRET") or "").strip()
)
GUMROAD_NAME = (os.environ.get("GUMROAD_NAME") or "meekotharaccoon").strip()
GUMROAD_ID   = (os.environ.get("GUMROAD_ID") or "").strip()
