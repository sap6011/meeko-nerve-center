...
def scan():
    ...
    caps = {
        "anthropic_api": {
            "name": "Claude API",
            "status": "active" if os.environ.get(_ak, "") else "missing",
            "impact": "SELF_BUILDER, KNOWLEDGE_WEAVER, REVENUE_OPTIMIZER, ARCHITECT all dead without this",
            "fix": "anthropic.com/console → API Keys → add os.environ.get(_ak, "") to GitHub Secrets",
            "blocks": ["SELF_BUILDER", "KNOWLEDGE_WEAVER", "REVENUE_OPTIMIZER", "NEURON_B"],
        },
        "gmail": {
            "name": "Gmail (send + read email)",
            "status": "active" if os.environ.get("GMAIL_ADDRESS") else "missing",
        ...
        "huggingface": {
            ...
            "fix": "Add os.environ.get(_ak, "") — HF fallback not needed if Claude works",
        ...
        "email_outreach": {
            ...
            "status": "active" if os.environ.get("GMAIL_APP_PASSWORD") else "missing",
    ...
    priority = (
        "os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("os.getenv("ANTHROPIC_API_KEY")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")")" if not os.environ.get(_ak, "") else
