...
SYSTEM_PROMPT = """You are Claude running as part of SolarPunk -- Meeko's autonomous AI system.
...
def call_claude(prompt, heavy=False, conversation_history=None):
    if not API_KEY:
        return None, "os.environ.get(_ak, "") not set"
...
def run_loop():
    ...
    if not API_KEY:
        log("WARNING: os.environ.get(_ak, "") not set -- AI features disabled")
        log("  Windows: $env:os.environ.get(_ak, "") = 'your-key-here'")
...
<Task version="1.4" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Actions>
    ...
    if err and "error" in err.lower():
        ...
        print("   Add os.environ.get(_ak, "") to environment for AI features")
