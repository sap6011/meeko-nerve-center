#!/usr/bin/env python3
"""
EXPERIMENT: mut_f5550b7f
TYPE:        MUTATION
BORN:        2026-03-21T15:26:41.897329Z
...
WHAT THIS DOES:
  ...
  Mutation vector:   json_io, http_fetch, file_io, loop_engine, data_scoring (from CRYPTO_BRIDGE)
  Result: a hybrid that does what CODE_ALCHEMIST does but through a CRYPTO_BRIDGE lens.
...
def mutate_gap_detector():
    ...
    out = EXPERIMENTS / "mutation_mut_f5550b7f.json"
