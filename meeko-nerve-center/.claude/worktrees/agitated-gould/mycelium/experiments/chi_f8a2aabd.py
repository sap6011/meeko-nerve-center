#!/usr/bin/env python3
"""
EXPERIMENT: chi_f8a2aabd
TYPE:        CHIMERA
BORN:        2026-03-21T15:29:20.612962Z
...
WHAT THIS DOES:
  Three-headed hybrid: reads knowledge (CRYPTO_BRIDGE), detects gaps,
...
def chimera_run():
    ...
    out = EXPERIMENTS / "chimera_chi_f8a2aabd.json"
