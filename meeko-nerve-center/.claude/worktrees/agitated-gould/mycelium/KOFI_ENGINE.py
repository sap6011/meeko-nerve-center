...
0% platform fee. Every $1 sale: 99c Gaza artists, 1c Loop Fund.
...
def process_events(state):
    ...
    for ev in new:
        ...
        to_gaza=round(amt*0.99,2); to_loop=round(amt*0.01,2)
...
<p class="sub">$1 AI art. 99¢ to Palestinian artists. 1¢ keeps the loop running.</p>
